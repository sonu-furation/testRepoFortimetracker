...
employeeRouter.post("/", employeeService.resetPassord.bind(employeeService));
employeeRouter.post("/verify", employeeService.verifyOtp.bind(employeeService));
employeeRouter.post("/changePass",isAuthenticatedUser, employeeService.changePassWord.bind(employeeService));
